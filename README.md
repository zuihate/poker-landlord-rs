...
- ✅ **基本的斗地主规则**：支持单牌、对子、三不带、三带一/二、四带二、炸弹、王炸、顺子、连对、飞机（含带单/带对）
- ✅ **智能牌型识别与大小比较**：严格按照经典斗地主规则
...
| 飞机带单         | PlaneWithSingle      | ≥8     | 飞机 + 等量单牌               |
| 飞机带对         | PlaneWithPair        | ≥10    | 飞机 + 等量对子               |
...
有任何问题或建议，欢迎在 [Issues](https://github.com/zuihate/poker-landlord-rs/issues) 中提出。